...
const updateCategoryValues = () => {
    ...
    chartOptions.value.graphic.elements[0].children[0].scaleX = sliderValue.value / 10
    chartOptions.value.graphic.elements[0].children[0].scaleY = sliderValue.value / 10
    chartOptions.value.graphic.elements[1].children[0].scaleX = 10 - sliderValue.value / 10
    chartOptions.value.graphic.elements[1].children[0].scaleY = 10 - sliderValue.value / 10
