<template>
  ...
  <HeaderCard name="protpriv" @filter="filterTag" id="dh"  :icons="[icon_l, icon_d]"/>
...
import icon_l from "@/assets/icons/dashboard/house.svg?url"
import icon_d from "@/assets/icons/dashboard/house_d.svg?url"
